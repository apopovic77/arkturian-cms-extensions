...
1. **Repository context**
   - Project lives at `/Volumes/DatenAP/Code/arkturian-cms-extensions`.
...
4. **Deployment target**
   - Built files go to `/var/www/arkturian-cms-extensions`.
   - Backups are stored with prefix `arkturian-cms-extensions` under `/var/backups/` (configurable via templates).

5. **Startup checklist for new session**
   - `cd /Volumes/DatenAP/Code/arkturian-cms-extensions`.
